    ...
    startupMemoryCategory() {
        this.mysqlConnection.query("SELECT COUNT(1) AS count FROM category", (err, result) => {
            if(result[0].count == 0) {
                ...
                ('Tatlılar', 'Çeşit çeşit tatlılar bulunmakta', 'https://drive.google.com/uc?id=1V3e2FzV-cPf61FN05evqFNLASfy5g6WF'),
                ('Çorbalar', 'Çorba çeşitleri içerir', 'https://drive.google.com/uc?id=1Gi7ntUIk8tbcDFcM7VPoa9c4u7UQ7FIY'),
                ('Pilavlar', 'Çeşitli pilavlar bulunmakta', 'https://drive.google.com/uc?id=1Ie1cPyM04sZB2EvpKWIA9sh499_9xab5');
                    `);
            }
        });
    }
